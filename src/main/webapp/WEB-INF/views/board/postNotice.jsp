        ...
        <div class="jarallax mt-2" data-jarallax data-speed="0.5">
          ...
          <div class="container py-3">
            ...
            <div class="col-md-6 col-sm-8 py-md-5 py-4 px-0">
              <h1 class="display-4 mb-4 pb-md-2" style="color: black; font-size: 3.8rem;"> &nbsp;Post Notice</h1>
              <p class="mb-sm-5 mb-4 pb-md-5 pb-3 lead" style="color: rgb(255, 115, 55);"> &nbsp;&nbsp;&nbsp;&nbsp;공지사항을 입력하세요.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="row justify-content-center pb-sm-2">
          <div class="col-lg-11 col-xl-10">
            ...
            <div class="bg-light rounded-3 p-4 p-md-5 mb-3">
              ...
              <form action="${path}/board/postNotice" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-12 mb-4">
              	...
              	<div><input type="hidden" name="dType" value="C" readonly></div>
                ...
                <div class="col-12 mb-4">
                  ...
                  <div class="position-relative">
                    ...
                    <label class="w-100" style="cursor:pointer;">
                      <span> 
                        <input class="form-control" type="file" name="upfile" id="pr-file" accept="image/gif, image/jpeg, image/png"> <!-- name="my-image" -->
                      </span>
                    </label>
                  </div>
          ...
          <!--      <a class="btn btn-primary btn-lg rounded-pill ms-sm-auto" type="submit" value="등록">등록<i class="fi-chevron-right fs-sm ms-2"></i></a>  -->
