...
<jsp:include page="/WEB-INF/views/common/header.jsp">
        ...
        <div class="jarallax mt-2" data-jarallax data-speed="0.5">
          ...
          <div class="container py-3">
            ...
            <div class="col-md-6 col-sm-8 py-md-5 py-4 px-0">
              ...
              <p class="mb-sm-5 mb-4 pb-md-5 pb-3 lead" style="color: rgb(255, 115, 55);"> &nbsp;&nbsp;&nbsp;&nbsp;의약품에 대한 후기를 남겨주세요.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="row justify-content-center pb-sm-2">
          <div class="col-lg-11 col-xl-10">
            ...
            <div class="bg-light rounded-3 p-4 p-md-5 mb-3">
              ...
              <form action="${path}/board/postPillReview" method="post">
              <div class="row">
	...
	var idValue = urlParams.get('pillNo');
