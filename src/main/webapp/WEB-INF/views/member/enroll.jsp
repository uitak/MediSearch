...
<!-- 회원가입 Modal-->
      <div class="enroll" id="signup-modal">
          ...
          <div class="modal-content">
            <div class="modal-body px-0 py-2 py-sm-0">
              ...
              <div class="row mx-0 align-items-center">
                ...
                <div class="col-md-6 px-2 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5"><h2 class="h3  mb-sm-2" style="width:180px; margin:0px auto;">카카오 회원가입</h2>
                  <div class="d-flex align-items-center py-3 mb-3">
                  </div>
                  <form action="${path}/member/enroll" method="post" class="needs-validation" novalidate>
                        <input class="form-control" type="hidden" name="kakaoToken" value="${kakaoMap.id}">
                    <div class="mb-2">
                      <label class="form-label" for="userId">아이디</label>
                      <div class="input-group">
                        <span class="input-group-text"><i class="fi-user"></i></span>
                        <input class="form-control" type="text" id="newId" name="userId" value="${kakaoMap.id}">
                        <input class="btn btn-outline-primary fs-sm" type="button" id="checkDuplicate" value="중복확인"/> <!-- id가 토큰번호입니다 == kakaoToken, id의 값이 같은 이유 -->
                      </div>
                    ...
                    <div class="mb-2">
                      ...
                      <input class="form-control"  type="text" id="signup-name" name="name" value="${kakaoMap.nickname}" placeholder="이름" required> <!-- id="signup-name" -->
                    </div>
                    <div class="mb-2">
                      <label class="form-label" for="signup-email">이메일</label>
                      <input class="form-control" type="email" id="signup-email" value="${kakaoMap.email}" name="email" placeholder="이메일" required>
                    </div>
                    <div class="mb-2">
