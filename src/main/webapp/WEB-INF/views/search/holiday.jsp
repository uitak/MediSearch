...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	...
	<script src="${path}/resources/js/address.js"></script>
      ...
      <section class="jarallax bg-dark zindex-1 py-xxl-5" data-jarallax data-speed="0.5" style="height: 500px;"><span class="img-overlay bg-transparent opacity-100" style="background-image: linear-gradient(0deg, rgba(31, 27, 45, .7), rgba(31, 27, 45, .7));"></span>
        <div class="jarallax-img" style="background-image: url(${path}/resources/img/medisearch/header/UCSF.jpg); height: 500px;"></div>
	...
	<form action="${path}/search/holiday" method="GET">
          ...
          <aside class="col-lg-4 col-xl-3 border-top-lg border-end-lg shadow-sm px-3 px-xl-4 px-xxl-5 pt-lg-2">
            <div class="offcanvas offcanvas-start offcanvas-collapse" id="filters-sidebar">
                  ...
                  <div class="tab-pane fade show active" id="filters" role="tabpanel">
                    <div class="pb-4 mb-2">
                      ...
                      <select class="form-select" name="searchType" id="searchType">
                        ...
                        <option value="hp" ${param.searchType == 'hp' ? 'selected' : ''}>병원</option>
                        <option value="ph" ${param.searchType == 'ph' ? 'selected' : ''}>약국</option>
                      </select>
                    </div>
              ...
              <!-- -------------------------시/도에 맞춰 구/군이 나타나기------------------------ -->
                    ...
                    <!-- id : 기관분류 코드 1,2로 구분-->
                    <div class="pb-4 mb-2" id="dutyDiv">
                      <h3 class="h6">기관별</h3>
                    ...
                    <div class="pb-4 mb-2" id="searchMD">
...
<!--               </div> -->
            		...
            		<c:forEach var="holiday" items="${list}">
						...
						<div class="col pb-sm-2">
						  <article class="position-relative">
						    ...
						    <c:if test="${holiday.dutyDivNam ne '약국'}">
							    <h3 class="mb-2 fs-lg" ><a class="nav-link stretched-link" href="${path}/search/hospitalInfo?hpid=${holiday.hpid}&i=${i}">${holiday.dutyName}</a></h3>
						    </c:if>
						    <c:if test="${holiday.dutyDivNam eq '약국'}">
							    <h3 class="mb-2 fs-lg" ><a class="nav-link stretched-link" href="${path}/search/pharmacyInfo?no=${holiday.pharmacyNo}&i=${i}">${holiday.dutyName}</a></h3>
						    </c:if>
						    <ul class="list-inline mb-0 fs-xs">
						      <li class="list-inline-item pe-1"><i class="fi-star-filled mt-n1 me-1 fs-base text-warning align-middle"></i><b>${holiday.star}</b><span class="text-muted">&nbsp;(${holiday.reviews})</span></li>
						      <li class="list-inline-item pe-1"><i class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>${holiday.dutyAddr}</li>
						      <li class="list-inline-item pe-1"><i class="fi-apartment mt-n1 me-1 fs-base text-muted align-middle"></i>${holiday.dutyDivNam}</li>
						    </ul>
						  </article>
						</div>
    ...
    <script type="text/javascript">
	    ...
	    $("#searchType").change(function() {
	    	...
	    	if(type == "all" || type == "hp") {
	    		$("#dutyDiv").css("display", "block"); 
	    		$("#searchMD").css("display", "block"); 
	    	}
	    	else {
	    		$("#dutyDiv").css("display", "none"); 
	    		$("#searchMD").css("display", "none"); 
	    	}
	    })
